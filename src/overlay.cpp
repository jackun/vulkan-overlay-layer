...
void TextOverlay::prepareRenderPass()
{
	...
	attachments[0].initialLayout = VK_IMAGE_LAYOUT_PRESENT_SRC_KHR; //vulkan tutorial sample
//	attachments[0].initialLayout = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL; //MESA overlay
